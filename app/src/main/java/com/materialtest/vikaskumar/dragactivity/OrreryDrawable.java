...
/**
 * Created by Vikas Kumar on 30-10-2015.
 */
public class OrreryDrawable extends LayerDrawable{
    ...
    public OrreryDrawable(Drawable[] bodies) {
        super(bodies);
    }
    ...
    public void setEarthPosition(float rotationEarth)
    {
        ...
        setLayerInset(EARTH_ID, (int) (earthCenter.x - RADIUS_EARTH), (int) (earthCenter.y - RADIUS_EARTH),
    ...
    public void setMoonPosition(float rotationMoon)
    {
        ...
        setLayerInset(MOON_ID, (int) (moonCenter.x - RADIUS_MOON), (int) (moonCenter.y - RADIUS_MOON),
    ...
    private Point getEarthCenter()
    {
        ...
        earthCenter.x = (int) (SPACE_HEIGHT/2 + ORBIT_EARTH*Math.sin(rotationEarth));
        earthCenter.y = (int) (SPACE_HEIGHT/2 + ORBIT_EARTH*Math.cos(rotationEarth));
        return earthCenter;
    }
    ...
    private Point getMoonCenter()
    {
        ...
        Point earthCenter = getEarthCenter();
        moonCenter.x = (int) (earthCenter.x + ORBIT_MOON*Math.sin(rotationMoon));
        moonCenter.y = (int) (earthCenter.y + ORBIT_MOON*Math.cos(rotationMoon));
        return moonCenter;
    }
